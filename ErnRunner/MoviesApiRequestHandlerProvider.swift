...
{
    /**
     * - Parameter movieConfig : Optional config object that can be passed to an api impl provider.
     */
    init(movieConfig: MoviesApiConfig? = nil)
    {
        super.init(config: movieConfig)
    }
